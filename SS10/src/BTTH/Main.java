...
public class Main {
    public static void main(String[] args) {
        Payable p1 = new CreditCard("Nguyen Van A", "CC01", "1234567812345678", "123", 10_000_000);
        Payable p2 = new EWallet("Tran Thi B", "EW01", "0987654321", 2_000_000);
        ...
        Payable reward = new Payable() {
            ...
            public void pay(double amount) {
                ...
                if (need > points) {
                    ...
                    points -= need;
                    System.out.println("Reward: Thanh toán " + amount + " (trừ " + need + " điểm)" + " | Điểm còn: " + points);
                }
            }
        };
        reward.pay(300_000);
